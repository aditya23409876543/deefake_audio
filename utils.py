...
class AudioDataset(Dataset):
    ...
    def __init__(self, data_source, data_dir=None, transform=None,max_len=64000, limit=10000, augment=False):
        ...
        self.audio_augment = Compose([
            ...
            #Shift(min_samples=int(-0.5*self.max_len), max_samples=int(0.5*self.max_len), p=0.2),
        ])
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            # Warn about failed file but continue
...
# Shared audio preprocessing utility
def preprocess_audio(audio_path, max_len=32000):
    """Extract all features from audio file"""
    import torch
    import numpy as np
    import librosa
    from utils import AudioDataset  # Avoid circular import if AudioDataset is here
